...
class Out_Segment {
  ...
  public:
    ...
    Out_Segment(TCPSegment seg,uint64_t _ackno_ab, uint64_t timeout,bool zero_window_size):_seg(seg) ,_ackno_absolute(_ackno_ab), _timeout(timeout), _zero(zero_window_size){ };
